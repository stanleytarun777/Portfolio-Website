  ...
  return (
    <section id="home" className="py-10 sm:py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-[minmax(0,0.52fr)_minmax(0,1.48fr)] lg:items-start lg:gap-8">

          {/* ── Left: Navy Identity Panel ── */}
          <div className="rounded-2xl bg-[#102948] p-5 text-white shadow-[0_8px_40px_rgba(15,23,42,0.2)] sm:p-6">

            {/* Image + text: stacked on mobile, side-by-side on sm+ */}
            <div className="flex flex-col gap-5 sm:flex-row sm:items-stretch">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-2xl font-bold tracking-tight text-white sm:text-xl lg:text-2xl">
                  {profile.name}
                </h1>
                <p className="mt-1 text-sm font-semibold text-white/60">{profile.role}</p>
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 rounded-full bg-[#0a66c2] px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition duration-200 hover:-translate-y-0.5 hover:bg-[#004182] hover:shadow-md"
                  >
                    <LinkedInIcon />
                    LinkedIn
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-3.5 py-2 text-xs font-semibold text-white transition duration-200 hover:-translate-y-0.5 hover:bg-white/18"
                  >
                    <GitHubIcon />
                    GitHub
                  </a>
          ...
          <div id="about" className="flex flex-col gap-5">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="rounded-2xl bg-[#102948] p-5 text-white shadow-[0_8px_32px_rgba(15,23,42,0.15)] sm:p-6">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1">
                  <span className="text-xs font-semibold uppercase tracking-widest text-white/70">Education</span>
                </div>
                <h3 className="mt-4 text-sm font-bold leading-snug text-white sm:text-base">{education.degree}</h3>
                <p className="mt-2 text-xs text-white/60 sm:text-sm">{education.school}</p>
