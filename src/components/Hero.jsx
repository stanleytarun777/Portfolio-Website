...
function DetailRow({ icon, text }) {
  return (
    <div className="detail-row">
      ...
      <p className="detail-row-text">{text}</p>
    </div>
  );
}
          ...
          <div className="hero-left">
            ...
            <div className="identity-card">
              <div className="identity-inner">
                ...
                <div className="identity-image-col">
                  <img
                    src={profile.image}
                  ...
                  <div className="social-buttons">
                    ...
                    <a href={profile.github} target="_blank" rel="noreferrer" className="social-btn social-btn-github">
                      <GitHubIcon />
                      GitHub
                    </a>
                  </div>
                ...
                <div className="identity-details">
                  ...
                  <p className="identity-tagline">Rising Senior</p>
            ...
            <div className="certs-card">
              <div className="certs-badge">
                <span className="certs-badge-text">Certifications</span>
              </div>
